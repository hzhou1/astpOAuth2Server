package au.edu.nsw.det.b2e.oauth.test;
...
import au.edu.nsw.det.b2e.oauth.model.AuthTokenInfo;
...
public class SpringRestClient {
    ...
    public static final String REST_SERVICE_URI = "http://localhost:8080/astpOAuth2Server";
    
    public static final String AUTH_SERVER_URI = "http://localhost:8080/astpOAuth2Server/oauth/token";
    
    //In-Memory
//    public static final String QPM_PASSWORD_GRANT = "?grant_type=password&username=bill&password=abc123";

    //Database
    public static final String QPM_PASSWORD_GRANT = "?grant_type=password&username=naveen&password=naveen";
